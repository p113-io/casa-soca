// https://codesandbox.io/s/astronaut-hfx8ks
...
function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./load/objects/astronaut/astronaut.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        ...
        <skinnedMesh castShadow receiveShadow name="Object_103" geometry={nodes.Object_103.geometry} material={materials.material_1} skeleton={nodes.Object_103.skeleton} scale={0.013} />
...
function Env() {
  const texture = useTexture('./load/objects/astronaut/space.jpg')
